...
namespace Transaction.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit(int id, [Bind("TransactionId,AcountNumber,BeneficiaryName,BankName,SWIFTCode,Amount,Date")] TransactionModel transactionModel)
        {
